...
const DeleteRecipe: React.FunctionComponent<DeleteRecipeProps> = ({ open, close, recipeID }: DeleteRecipeProps) => {
    ...
    return (
        <Dialog open={open} onClose={close}>
            ...
            <DialogActions>
                <Button disabled={deleteMutation.isLoading} onClick={close} autoFocus variant="outlined" color="secondary">
